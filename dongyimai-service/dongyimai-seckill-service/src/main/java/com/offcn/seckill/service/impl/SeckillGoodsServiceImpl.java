...
public class SeckillGoodsServiceImpl extends ServiceImpl<SeckillGoodsMapper,SeckillGoods> implements SeckillGoodsService {
    ...
    @Override
    public List<SeckillGoods> list(String timeStr) {
        return redisTemplate.boundHashOps("SeckillGoods_" + timeStr).values();
    }
     ...
     */
    @Override
    public SeckillGoods one(String timeStr, Long id) {
        return (SeckillGoods) redisTemplate.boundHashOps("SeckillGoods_" + timeStr).get(id);
    }
}
