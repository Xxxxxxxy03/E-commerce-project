...
public class SpecificationController {
    ...
    @PostMapping
    public Result add(@RequestBody  @ApiParam(name = "Specification对象",value = "传入JSON数据",required = true)SpecEntity specEntity){
     ...
     * @return
     */
    @ApiOperation(value = "查询所有Specification",notes = "查询所有Specification方法详情",tags = {"SpecificationController"})
    @GetMapping
     ...
     * @return
     */
    @ApiOperation(value = "获取规格下拉列表",notes = "获取规格下拉列表方法详情",tags = {"SpecificationController"})
    @GetMapping("/selectOptions")
    public Result<List<Map>> selectOptions(){
        List<Map> list = specificationService.selectOptions();
        return new Result(true,StatusCode.OK,"获取规格下拉列表成功！",list);
    }
}
