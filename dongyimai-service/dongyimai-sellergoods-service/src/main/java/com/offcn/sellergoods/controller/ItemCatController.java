...
public class ItemCatController {
     ...
     * @return
     */
    @ApiOperation(value = "根据父类id查看分类列表",notes = "根据父类id查看分类列表方法详情",tags = {"ItemCatController"})
   @ApiImplicitParam(name="parentId",value = "父类id",required = true,type = "Long")
    ...
    public Result<List<ItemCat>> findByParentId(Long parentId){
        ...
        return new Result(true,StatusCode.OK,"根据父类id查看分类列表成功！",list);
    }
}
