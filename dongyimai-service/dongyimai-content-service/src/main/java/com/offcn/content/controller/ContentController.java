...
public class ContentController {
    ...
    //根据广告分类获取广告数据集合
    @ApiOperation(value = "根据广告分类获取广告数据集合",notes = "根据广告分类获取广告数据集合",tags = {"Controller"})
    @ApiImplicitParam(name = "id",value = "编号",required = true,type = "path")
    ...
    public Result<List<Content>> findByCategoryId(@PathVariable("id") Long id){
        ...
        return new Result(true,StatusCode.OK,"读取广告数据成功",contentList);
    }
}
